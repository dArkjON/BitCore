...
pkgdatadir = $(datadir)/bitcore
pkgincludedir = $(includedir)/bitcore
pkglibdir = $(libdir)/bitcore
pkglibexecdir = $(libexecdir)/bitcore
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/bitcore_find_bdb48.m4 \
	$(top_srcdir)/build-aux/m4/bitcore_qt.m4 \
	$(top_srcdir)/build-aux/m4/bitcore_subdir_to_include.m4 \
...
ACLOCAL = ${SHELL} '/root/work/Bitcore-0.18/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} '/root/work/Bitcore-0.18/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/root/work/Bitcore-0.18/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/root/work/Bitcore-0.18/build-aux/missing' automake-1.16
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
BITCOIN_CLI_NAME = bitcore-cli
BITCOIN_DAEMON_NAME = bitcored
BITCOIN_GUI_NAME = bitcore-qt
BITCOIN_TX_NAME = bitcore-tx
...
CLIENT_VERSION_MINOR = 90
CLIENT_VERSION_REVISION = 9
COMPAT_LDFLAGS = 
COPYRIGHT_HOLDERS = The %s developers
COPYRIGHT_HOLDERS_FINAL = The BitCore Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = BitCore Core
COPYRIGHT_YEAR = 2025
CPP = gcc -E
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/root/work/Bitcore-0.18/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = bitcore
PACKAGE_BUGREPORT = https://github.com/LIMXTEC/bitcore/issues
PACKAGE_NAME = BitCore BTX
PACKAGE_STRING = BitCore BTX 0.90.9
PACKAGE_TARNAME = bitcore
PACKAGE_URL = https://bitcore.cc/
PACKAGE_VERSION = 0.90.9
PATH_SEPARATOR = :
PIC_FLAGS = -fPIC
PIE_FLAGS = -fPIE
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /root/work/Bitcore-0.18
abs_srcdir = /root/work/Bitcore-0.18
abs_top_builddir = /root/work/Bitcore-0.18
abs_top_srcdir = /root/work/Bitcore-0.18
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/work/Bitcore-0.18/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/bitcore.icns
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/bitcore.ico \
  $(top_srcdir)/share/pixmaps/bitcore-nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/bitcore-nsis-wizard.bmp \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcore.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/BitCore-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/Resources/bitcore.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/BitCore-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitCore-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitCore-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
