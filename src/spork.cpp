...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM:          r = SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM:          return SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM")    return SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM:     return "SPORK_BTX_22_MASTERNODE_RANK_PAYMENT_SYSTEM";
